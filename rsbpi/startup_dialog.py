...
class StartupDialog(QtWidgets.QDialog):
    ...
    def setup_ui(self):
        ...
        title_font = QtGui.QFont(self.font().family(), 18, QtGui.QFont.Weight.Bold)
        title.setFont(title_font)
        title.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        main_layout.addWidget(title)

        mode_group = QtWidgets.QGroupBox("Mode")
        mode_group.setFont(QtGui.QFont(self.font().family(), 14, QtGui.QFont.Weight.Bold))
        ...
        type_group.setFont(QtGui.QFont(self.font().family(), 14, QtGui.QFont.Weight.Bold))
